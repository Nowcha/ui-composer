/**
 * Component catalog seed data.
 * Edit THIS file (never src/data/components.json) and run `npm run gen:catalog`.
 *
 * Phase 1 scope: 20 core components. Expands to 60 in Session 2
 * following prompts/01-catalog-generation.md.
 */
